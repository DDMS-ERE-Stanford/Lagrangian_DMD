...
print -depsc2 dmd_advection_diffusion.eps
...
% 
% for i = 1:length(t)-1
%     y_hat(:,i+1) = A2_hat\(y_hat(:,i)+dt*U_k'*[advection*ones(Nx,1);zeros(Nx,1)]);
...
%     'FontSize',9);
% 
% print -depsc2 pod_advection_diffusion.eps
% 
% error_dmd = sqrt(sum((Ul-X_dmd(Nx+1:end,:)).^2,1));
% error_pod = sqrt(sum((Ul-u_pod).^2,1));
% figure
...
%     'FontSize',9);
% 
% print -depsc2 error_advection_diffusion.eps
% 
...
%     'FontSize',9);
% 
% print -depsc2 error_bd_advection_diffusion.eps
